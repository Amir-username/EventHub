...
# ── Override environment for tests (before any app import) ──────────
# These must be set BEFORE pydantic-settings reads the .env file.
# We use hard assignment (not setdefault) so test values always win.
os.environ["SECRET_KEY"] = "test-secret-key-for-tests-not-real"
